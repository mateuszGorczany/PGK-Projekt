...
protected:
	...
	*/
	void m_Image_BoxOnLeftUp(wxMouseEvent& event);
	/**
	Pobieranie koloru hexagonu
	*/
	void m_color_Hexagon_BoxOnLeftUp(wxMouseEvent& event);
	/**
	Odświeżanie
	*/
...
private:
	...
	*/
	...
	/**
	Przechowuje wartości referencyjne RGB piksela
	*/
	wxImage::RGBValue Img_RGB_ref;
	/**
	Przechowuje wartości modyfikowane RGB piksela
	*/
