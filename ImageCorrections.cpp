...
Frame::Frame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxFrame(parent, id, title, pos, size, style)
{
	...
	m_Image_Box = new wxScrolledWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
	m_Image_Box->SetScrollRate(20, 20);
	...
	// Connect Events
	m_Image_Box->Connect(wxEVT_LEFT_UP, wxMouseEventHandler(Frame::m_Image_BoxOnLeftUp), NULL, this);
	m_Color_Hexagon_Box->Connect(wxEVT_LEFT_UP, wxMouseEventHandler(Frame::m_color_Hexagon_BoxOnLeftUp), NULL, this);
...
{
	// Disconnect Events
	m_Image_Box->Disconnect(wxEVT_LEFT_UP, wxMouseEventHandler(Frame::m_Image_BoxOnLeftUp), NULL, this);
	m_Color_Hexagon_Box->Disconnect(wxEVT_LEFT_UP, wxMouseEventHandler(Frame::m_color_Hexagon_BoxOnLeftUp), NULL, this);
